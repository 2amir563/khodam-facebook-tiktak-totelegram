...
```
bash -c "$(curl -fsSL https://raw.githubusercontent.com/2amir563/khodam-facebook-tiktak-totelegram/main/install.sh)"
```
...
./start_bot.sh
```
دستورات برای شروع استفاده:
bash
# 1. برو به دایرکتوری بات
cd /root/telegram-video-bot
